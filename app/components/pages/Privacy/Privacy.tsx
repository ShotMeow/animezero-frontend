...
const Privacy: FC = () => {
	return (
		<Layout title='AnimeZero - Политика конфиденциальности'>
			<Heading
				catalog='Политика конфиденциальности'
			...
			<div className={styles.conf}>
				<ol>
					<li>
						...
						<ol>
							...
							<li>
								...
								<strong> https://animezero.ru.</strong>
							</li>
						</ol>
					</li>
					<li>
						...
						<ol>
							...
							<li>
								...
								веб-сайта <strong> https://animezero.ru.</strong>
							</li>
							<li>
					...
					<li>
						<h4>Основные права и обязанности Оператора</h4>
						<ol>
							<li>
					...
					<li>
						<h4>Основные права и обязанности субъектов персональных данных</h4>
						<ol>
							<li>
					...
					<li>
						...
						<ol>
							...
							<li>
								...
								электронной почты <strong>admin@animezero.ru</strong> с пометкой
					...
					<li>
						...
						<ol>
							...
							<li>
								...
								Оператора admin@animezero.ru с пометкой «Актуализация
								персональных данных».
							</li>
							<li>
								...
								электронный адрес Оператора <strong>admin@animezero.ru </strong>
					...
					<li>
						<h4>Конфиденциальность персональных данных</h4>
						<p>
					...
					<li>
						...
						<ol>
							...
							<li>
								...
								<strong> https://animezero.ru/privacy/</strong>.
							</li>
						</ol>
					</li>
				</ol>
